#!/usr/bin/env python3
"""Owner Card Pipeline — v65 (FaCTS Section Validation + Full Snapshots + NeedsReviewNotes)
...
Run:
  python3 owner_cards_pipeline_v65.py
  or
  python3 owner_cards_pipeline_v65.py --pdf "B (all).pdf" --out "OwnerCards_B_Output.xlsx"
