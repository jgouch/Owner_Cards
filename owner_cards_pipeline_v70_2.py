#!/usr/bin/env python3
"""Owner Card Pipeline — v70.2 (FaCTS Section Validation + Full Snapshots + NeedsReviewNotes)
...
Run:
  python3 owner_cards_pipeline_v70_2.py
  or
  python3 owner_cards_pipeline_v70_2.py --pdf "B (all).pdf" --out "OwnerCards_B_Output.xlsx"
...
def _auto_rotate_by_header_score(pil_img: Image.Image, header_ratio: float = 0.35) -> tuple[Image.Image, dict]:
    ...
    for angle in (0, 90, 180, 270):
        try:
            ...
            txt = pytesseract.image_to_string(header_pp, config="--oem 3 -l eng --psm 6")
...
# -----------------------------
# v70.2 PROPERTY HEURISTICS (garden + coordinate OCR fuzz)
# -----------------------------
DEFAULT_GARDENS = [
    "GOOD SHEPHERD",
    "EVERLASTING LIFE",
...
# --- Structural / colon-style property detection (v70.2 fix) ---
