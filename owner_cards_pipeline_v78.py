#!/usr/bin/env python3
"""Owner Card Pipeline — v78 (Line Stitching + FaCTS Space Fallback + Notes OCR Lists)
...
Run:
  python3 owner_cards_pipeline_v78.py
  or
  python3 owner_cards_pipeline_v78.py --pdf "B (all).pdf" --out "OwnerCards_B_Output.xlsx"
